...
$lift_type = isset($_POST['lift_type']) ? strip_tags(htmlspecialchars($_POST['lift_type'])) : '';
$move_floor = isset($_POST['move_floor']) ? strip_tags(htmlspecialchars($_POST['move_floor'])) : '';
$move_hour = isset($_POST['move_hour']) ? strip_tags(htmlspecialchars($_POST['move_hour'])) : '';
...
$body .= "Datum: $date\n";
$body .= "Tijd: $time\n";
$body .= "Type van Lift: $lift_type\n";
$body .= "Verdieping verhuis: $move_floor\n";
$body .= "Uur verhuis: $move_hour\n";
